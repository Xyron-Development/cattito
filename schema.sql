...
CREATE TABLE public.profile (
    ...
    "cat_eboy" integer DEFAULT 0,
    "cat_f34rmp4" integer DEFAULT 0,
    "cat_snacc" integer DEFAULT 0,
    "cat_unknown" integer DEFAULT 0
    ...
    hello_cat boolean DEFAULT false,
    i_love_cats boolean DEFAULT false,
    lag_king boolean DEFAULT false,
    bruh boolean DEFAULT false,
    meow boolean DEFAULT false,
    oops boolean DEFAULT false,
    pizza_time boolean DEFAULT false,
    troll_cat boolean DEFAULT false,
    big_brain boolean DEFAULT false,
    catception_phrase boolean DEFAULT false,
    hello_world boolean DEFAULT false,
    why boolean DEFAULT false,
    stupid_cat boolean DEFAULT false,
    f34r boolean DEFAULT false
);
